        ...
        <div class="col-xs-6 col-md-3">
          ...
          <ul class="footer-links">
            <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-envelope" 
              ...
              </svg>: lemezbazisugyfelszolg@gmail.com</li>
          </ul>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <ul class="social-icons">
            <!-- <li><svg xmlns="http://www.w3.org/2000/svg" width="32" height="20" fill="white" class="bi bi-instagram instagram"
                viewBox="0 0 16 16">
                <path
            ...
            <li><a href="https://github.com/laladornyei/lemezbazis"><svg  xmlns="http://www.w3.org/2000/svg" width="32" height="20" fill="white" class="bi bi-github"
                viewBox="0 0 16 16">
                <path
